...
class CurrentContestsListFragment :
        WithProcessingFragment<Contest>(),
        ContestsListFragmentContractor.View {
    ...
    override fun getEmptyListMessageText(): String = getString(R.string.emptyCurrentContestsList)
